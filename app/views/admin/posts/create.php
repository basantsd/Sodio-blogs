...
<div class="container-fluid">
    ...
    <?php include BASE_PATH.'/app/views/admin/include/sidenav.inc.php'; ?>
        <main class="col-md-9 my-4 ms-sm-auto col-lg-10 px-md-4">
            ...
            <?php endif; ?>
            <form action="<?= APP_URL.'/admin/posts/create'; ?>" method="POST" enctype="multipart/form-data" >
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12">
                        ...
                        <textarea rows="7" class="form-control" id="postDescription" name="description"></textarea>
                    </div>
                    <div class="mb-3 col-6">
                        <label for="postPublishDate" class="form-label">Publish Date</label>
                        <input type="date" class="form-control" id="postPublishDate" name="publish_date">
                    </div>
                    <div class="mb-3 col-6">
